...
public class FollowerConstants {
    ...
    private static double xMovement = 67.82063149819855;
    private static double yMovement = 47.13057621815969166667;
    ...
    public static double forwardZeroPowerAcceleration = -65.1540716134598383333;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -84.65252983995585;
